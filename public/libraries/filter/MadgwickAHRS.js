...
class MadgwickAHRS {
    ...
    MadgwickAHRSupdate = function (gx, gy, gz, ax, ay, az, mx, my, mz, dt = 1 / this.sampleFreq) {
        let recipNorm;
        let s0, s1, s2, s3;
        ...
        let q3 = this.q3;
        let beta = this.beta;
        let sampleFreq = this.sampleFreq;

        // Use IMU algorithm if magnetometer measurement invalid (avoids NaN in magnetometer normalisation)
        if ((mx == 0.0) && (my == 0.0) && (mz == 0.0)) {
            this.MadgwickAHRSupdateIMU(gx, gy, gz, ax, ay, az, dt);
            return;
        }
    ...
    MadgwickAHRSupdateIMU = function (gx, gy, gz, ax, ay, az, dt = 1 / this.sampleFreq) {
        let recipNorm;
        let s0, s1, s2, s3;
        let qDot1, qDot2, qDot3, qDot4;
