...
class CrazePonyIMUo3Class {
    ...
    IMUSO3Thread = function (imu, param, TS, imuMadgwickAHRS = null) {
        //! Time constant
        ...
        imuMadgwickAHRS.MadgwickAHRSupdate(gyro[0], gyro[1], gyro[2],
            acc[0], acc[1], acc[2],
            mag[0], mag[1], mag[2],
            dt);
        ...
        let eurla = fusionQuaternion2Eular(this.q0, this.q1, this.q2, this.q3);
